...
class ValidatorsTest {
  ...
  void flagsMissingAssociationAsError() {
    ...
    List<ParseIssue> issues = new Validators().validateRow(row, Discipline.HERREN, 3, "raw");
  ...
  void juniorRowsMayNeverHaveEmptyPoints() {
    ...
    List<ParseIssue> issues = new Validators().validateRow(row, Discipline.JUNIOREN, 3, "raw");
