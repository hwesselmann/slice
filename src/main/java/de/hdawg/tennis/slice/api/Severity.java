 ...
 *
 * <p>In {@link ParseMode#STRICT STRICT} mode any {@code ERROR} causes an {@link
 * IllegalStateException}. In {@code LENIENT} mode the affected row or metadata field is skipped and
 * the issue is collected in the {@link ParseResult}.
 */
