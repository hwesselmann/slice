...
import de.hdawg.tennis.slice.metadata.DisciplineDetector;
import de.hdawg.tennis.slice.metadata.MetadataExtractor;
import de.hdawg.tennis.slice.parse.DataLineFilter;
import de.hdawg.tennis.slice.parse.Line;
import de.hdawg.tennis.slice.parse.LineGrouper;
import de.hdawg.tennis.slice.parse.ParsedRow;
import de.hdawg.tennis.slice.parse.RowParser;
import de.hdawg.tennis.slice.pdf.PdfWordExtractor;
...
import de.hdawg.tennis.slice.validate.Validators;
...
public final class Slice {
   ...
   *   <li>Parse each data line into a {@link RankingEntry}.
